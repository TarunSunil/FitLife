...
export default function WorkoutLogsList({
  ...
  const deleteLog = (logId: string) => {
    if (deletionConfirmationEnabled && !window.confirm("Delete this workout log?")) {
      return;
    }
  ...
  return (
    <section className="space-y-4 rounded-2xl border border-white/10 bg-zinc-950/80 p-4">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
        <label className="rounded-xl border border-white/10 bg-black px-2 py-2 text-xs text-zinc-300 sm:px-3">
          ...
          <input
            ...
            className="w-full rounded-md border border-white/10 bg-zinc-950 px-2 py-3 text-base text-white outline-none focus:border-lime-500 sm:py-1.5 sm:text-sm"
              ...
              {inEdit ? (
                <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                  <input
                    ...
                    className="rounded-md border border-white/10 bg-zinc-950 px-2 py-3 text-base text-white outline-none focus:border-lime-500 sm:py-1.5 sm:text-sm"
                  />
                  <input
                    type="number"
                    inputMode="numeric"
                ...
                <div className="grid grid-cols-3 gap-1 text-xs text-zinc-300 sm:gap-2">
                  <p className="rounded-md border border-white/10 bg-zinc-950 px-1.5 py-1.5 sm:px-2">
                ...
                {inEdit ? (
                  <>
                    <button
                      ...
                      className="w-full rounded-md border border-white/20 px-2.5 py-3 text-sm text-zinc-300 sm:w-auto sm:py-1.5 sm:text-xs"
                    >
                      Cancel
                    </button>
                    <button
                      ...
                      onClick={saveEdit}
                      disabled={pending}
                      className="w-full rounded-md bg-lime-500 px-2.5 py-3 text-sm font-semibold text-black disabled:opacity-60 sm:w-auto sm:py-1.5 sm:text-xs"
                    >
                      Save
                    </button>
                  </>
                  ...
                  <>
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-1 rounded-md border border-white/20 px-3 py-3 text-xs text-zinc-300"
                    >
                    ...
                    <button
                      ...
                      disabled={pending}
                      className="inline-flex items-center justify-center gap-1 rounded-md border border-red-500/40 px-3 py-3 text-xs text-red-300 disabled:opacity-60"
                    >
